...
class MainActivity : FragmentActivity() {
    ...
    private val fm = BaseFragmentManager(supportFragmentManager, R.id.mainFragment)
    ...
    fun openAsRootForFragment(fragmentClass: Class<*>, bundle: Bundle? = null) {
        fm.openAsRoot(fragmentClass, bundle)
    }
}
